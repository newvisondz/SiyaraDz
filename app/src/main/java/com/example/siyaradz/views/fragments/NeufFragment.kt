 ...
 * [NeufFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [NeufFragment.newInstance] factory method to
...
class NeufFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        test.text = "OKay now it's working"
    }
    companion object {
        /**
         ...
         * @return A new instance of fragment NeufFragment.
         */
